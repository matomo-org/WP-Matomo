...
// WP-Matomo customization
if (file_exists(__DIR__ . '/config.local.php')) {
    include __DIR__ . '/config.local.php';
}

// WP-Matomo customization: config.php calls wp-load.php which on multisite networks
// redeclares and messes up $path, so save it here and restore it after the include.
